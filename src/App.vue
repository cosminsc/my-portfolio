...
<template>
   <div class="lg:container mx-auto py-0 lg:py-4 lg:pl-[300px] relative">
      <div @click="toggleSidebar"
         ...
         <img class="inline-block size-11 rounded-full ring-2 ring-sky-500" src="/images/author-avatar-small.jpg"
            alt="" />
      </div>
      <!-- Sidebar -->
      <div
      ...
      <div class="bg-zinc-800/40 min-h-[calc(100vh-32px)] pb-11 relative">
         <div @click="isSidebarOpen = false" class="absolute left-0 top-0 right-0 bottom-0 z-10 bg-zinc-900/90"
