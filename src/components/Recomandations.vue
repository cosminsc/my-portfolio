...
const list = [
   ...
   {
      author: 'Frank van Driel',
      country: 'Netherlands',
      quote: 'Cosmin is great! He is good and always available if you need him! 24/7',
   },
   {
      author: 'Jon Traister',
      country: 'United States',
      quote: 'Cosmin Schiopu did an amazing job. I will use his services again.',
   },
   {
      author: 'Adrian Harrison',
      country: 'Australia',
      quote: 'Great design skills. Gets job done on time and has great English!',
   },
]
</script>
<template>
